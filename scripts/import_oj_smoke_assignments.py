...
def main() -> None:
    parser = argparse.ArgumentParser(description="Import teacher-owned OJ smoke assignments")
    parser.add_argument("--teacher", default="teacher", help="Teacher username (must match login account to show in 我的作业)")
