export default {
    ...
    noSectionsData: 'No section data for the current chapter.',
    numberOfPoints: 'no knowledge points | 1 knowledge points | {number} knowledge points',
    ...
    noLearningPosition:'No {label} learning position',
    completeLearningPosition:'{label} {current}/{total} · Complete {completed}',

    none: 'None',

    currentSection: 'Current Section',
    currentPoint: 'Current Knowledge Point',

    pointDetail: '',
    noPointDetail: 'No Node Description',

    learningStatus: 'Learning Status: {status}',
    averageMastery: 'Average Mastery: {value}%',
    averageCompletion: 'Average Completion: {value}%',
    averageStudyDuration: 'Average Study Duration: {minutes} minutes',
